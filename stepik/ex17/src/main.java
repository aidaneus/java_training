...
public class main {
	...
	static class RobotConnectionException extends RuntimeException implements Dublicated {
	...
	static class MyException extends RuntimeException implements Dublicated {
		public MyException() {
			super();
		}
